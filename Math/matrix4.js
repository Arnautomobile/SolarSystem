class Matrix4 {
	...
	makePerspective(fovy, aspect, near, far) {
		var fov = fovy * Math.PI / 360;
		const e = this.elements;
		e[0] = 1/(aspect*Math.tan(fov)); e[1] = 0; e[2] = 0; e[3] = 0;
		e[4] = 0; e[5] = 1/Math.tan(fov); e[6] = 0; e[7] = 0;
	...
	makeOrthographic(l, r, t, b, n, f) {
		const e = this.elements;
		e[0] = 2/(r-l); e[1] = 0; e[2] = 0; e[3] = -(r+l)/(r-l);
		e[4] = 0; e[5] = 2/(t-b); e[6] = 0; e[7] = -(t+b)/(t-b);
		e[8] = 0; e[9] = 0; e[10] = 2/(n-f); e[11] = -(f+n)/(f-n);
		e[12] = 0; e[13] = 0; e[14] = 0; e[15] = 1;
		return this;
	}
